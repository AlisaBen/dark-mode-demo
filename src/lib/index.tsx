...
import { loadTheme, ITheme as ComputedTheme } from "./loadThemedStyles.js";
import serializedVariableGroups from "./themes";
import Parser from "./parser";

import { tree, contexts, functionRegistry } from "./runtime";
...
const ThemeContext = React.createContext<[ThemeState, ThemeAction] | undefined>(
  undefined
);

const deserialize = (node: any): any => {
...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({
  ...
  const set = React.useCallback((value: ThemeOptions) => {
    console.log(onChangeRef.current);
