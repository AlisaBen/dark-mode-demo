...
const themesModulePath = path.resolve(__dirname, '../src/lib/themes.js');
...
class AntdThemePlugin {
  ...
  //   [ { name: 'dark',
  //   filename:
  //    '/Users/bytedance/Desktop/official/test/dark-mode-demo/node_modules/antd/lib/style/themes/dark.less' },
  // { name: 'compact',
  //   filename:
  //    '/Users/bytedance/Desktop/official/test/dark-mode-demo/node_modules/antd/lib/style/themes/compact.less' } ]

    const runtimeVariableNames = options.variables || []; // [ 'primary-color' ]
  ...
  //     [ '/Users/bytedance/Desktop/official/test/dark-mode-demo/node_modules/antd/lib/style/themes/default.less',
  // '/Users/bytedance/Desktop/official/test/dark-mode-demo/node_modules/antd/lib/style/themes/dark.less',
  // '/Users/bytedance/Desktop/official/test/dark-mode-demo/node_modules/antd/lib/style/themes/compact.less' ]
      ...
      // default.less中每一个变量的映射关系，
      // console.log('defaultVariables')
      // console.log(themeVariableGroups); // dark.less和compact.less文件的变量映射关系
      ...
      ); // 把默认的变量分别和compact和dark.less文件中的变量进行merge和覆盖
